...
bool APIC::regist(APIC apic) {
	...
	do {
		string area, subarea;
		int pick2;
		cout << "How do you want to visualize the areas of interest?" << endl;
		...
		cout << "Please choose the area you want to add: " << endl;
		cout << "Your area: ";
		cin >> area;
		cin.clear();
		cin.ignore(10000, '\n');
		...
		if (checkArea(area)) {
			printSubArea(area);
			cout << "Now please pick a sub area: " << endl;
			cout << "Your sub area: ";
			cin >> subarea;
			cin.clear();
			cin.ignore(10000, '\n');
...
void APIC::printSubAreasUser() {
	string area;
	cout << "What is the area you want to look for sub areas (type ; for return)?";
	cin >> area;
	cin.clear();
	cin.ignore(10000, '\n');
	if (findSemicolon(area))
